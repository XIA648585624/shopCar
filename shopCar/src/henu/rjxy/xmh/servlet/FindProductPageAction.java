...
public class FindProductPageAction extends HttpServlet{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Product> pros = ps.findProByPage(currentPage, pageSize);
		Integer pageNum = ps.getPageNum(pageSize);//获取总页数
